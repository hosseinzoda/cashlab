import type { Fraction, TokenId, PayoutRule, Output, OutputWithFT, SpendableCoin } from '@cashlab/common/types.js';
import { NATIVE_BCH_TOKEN_ID, SpendableCoinType } from '@cashlab/common/constants.js';
import { bigIntArraySortPolyfill } from '@cashlab/common/util.js';
import { InvalidProgramState, ValueError, InsufficientFunds } from '@cashlab/common/exceptions.js';
