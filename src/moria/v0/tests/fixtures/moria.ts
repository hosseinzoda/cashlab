...
import type { UTXOWithNFT } from '../../../../common/types.js';
import { NonFungibleTokenCapability } from '../../../../common/constants.js';
...
export const DUMMY_SUNSET_MESSAGE = new Uint8Array(Buffer.from('SUNSET!', 'utf8'));
export const DUMMY_SUNSET_DATASIG = secp256k1.signMessageHashSchnorr(DUMMY_SUNSET_PRIVATE_KEY, new Uint8Array(createHash('sha256').update(DUMMY_SUNSET_MESSAGE).digest())) as Uint8Array;
